...
func (uc *BlogController) DeleteById(ctx *gin.Context) {
	req := &request.BlogDeleteByIdRequest{}
	res := &DeleteByIdActiveBlogResponse{}
...
func (c *DeleteByIdActiveBlogResponse) SetErr(err error) {
